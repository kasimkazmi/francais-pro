...
const ThemeError = ({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) => {
    return (
        <ErrorScreen 
            error={error}
            reset={reset}
            title="Theme Management Error"
            description="Failed to load theme management settings. This could be due to a network issue or database connection problem. Please try again."
            showHome={false}
            customActions={
